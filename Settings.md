...
**NOTE:** If you want to use the automatically generated configuration, your first LED should start in the bottom half of your monitor and then clockwise or anticlockwise like in the image below.
